...
import mlflow
import dagshub
dagshub.init(repo_owner='Kartiksingh007', repo_name='networksecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classificationmetric):
        with mlflow.start_run():
            ...
            mlflow.sklearn.log_model(best_model,name="network_security_model")
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        best_model_name=max(model_report,key=lambda x: model_report[x]["model_score"]
        )

        best_model=model_report[best_model_name]["best_model"]
        best_model_score=model_report[best_model_name]["model_score"]
